...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "dataUser" | "faseUser" | "pans" | "recipe";
        ListRelations: "dataUser" | "faseUser" | "pans" | "recipe";
        Relations: {
            dataUser: {
                Shape: DataUser[];
                Name: "DataUser";
    ...
    Details: {
        ...
        Create: {};
        Update: {};
        RelationName: "macro" | "food" | "brand" | "join_meal_food" | "specifics" | "join_shops" | "join_recipe";
